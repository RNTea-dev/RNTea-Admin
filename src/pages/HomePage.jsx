...
export default function HomePage() {
    return (
        // Outermost container for the background image
        // It now uses flex-grow to expand within its parent (<main>) which is a flex container.
        // It also has min-h-0 to prevent it from collapsing if content is smaller than parent.
        ...
        >
            ...
            {/* Centering container for the main content card */}
            {/* This div will now handle the centering of the white content box on top of the full-height background */}
