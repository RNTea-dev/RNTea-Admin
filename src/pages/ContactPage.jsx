...
const ContactPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Simulate form submission (in a real app, you'd send this to a server/Firebase Function)
    ...
    return (
        <main className="flex-grow bg-gray-100">
            {/* Hero Section */}
            <section className="wavy-bg text-white py-20 px-4 text-center overflow-hidden">
            ...
            <div className="container mx-auto px-4 py-12">
                <section className="bg-white p-8 rounded-lg shadow-xl grid md:grid-cols-2 gap-12 animated-section fade-in">
                    ...
                    <div className="animated-section px-6" style={{ animationDelay: '0.1s' }}>
                        ...
                        {formMessage.text && (
                            <div className={`p-3 rounded-md mb-4 ${formMessage.type === 'success' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'} animated-text`} style={{ animationDelay: '0.3s' }}>
                                {formMessage.text}
                            </div>
                        )}
                    ...
                    <div className="animated-section px-6" style={{ animationDelay: '0.3s' }}>
                        ...
                        <div className="text-center mt-12 animated-text" style={{ animationDelay: '0.7s' }}>
                            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Social Media</h3>
                            {/* Updated social media icons with provided SVGs */}
                            <div className="flex space-x-6 justify-center md:justify-start">
                                <a href="https://facebook.com/rntea" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transform hover:scale-125 transition-transform duration-300 pop-in-item" style={{ transitionDelay: '0.5s' }}>
                                ...
                                <a href="https://twitter.com/rntea" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-400 transform hover:scale-125 transition-transform duration-300 pop-in-item" style={{ transitionDelay: '0.6s' }}>
                                ...
                                <a href="https://linkedin.com/company/rntea" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-700 transform hover:scale-125 transition-transform duration-300 pop-in-item" style={{ transitionDelay: '0.7s' }}>
                                ...
                                <a href="https://instagram.com/rntea" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-pink-500 transform hover:scale-125 transition-transform duration-300 pop-in-item" style={{ transitionDelay: '0.8s' }}>
